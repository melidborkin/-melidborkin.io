...
<main id="container">
  ...
  <div class='content'>
    <section id="home">
      ...
      <p class="leyenda">
        El tamaño de cada envase, junto a cada número, reflejan el impacto simbólico dentro de la evolución publicitaria de la marca o el moto invertido en millones de USD <br>
